...
import com.vividprojects.protoplanner.databinding.VariantFullBinding;
...
public class VariantItemFragment extends Fragment implements Injectable {
    private VariantItemViewModel model;

    private VariantFullBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = VariantFullBinding.inflate(inflater);
