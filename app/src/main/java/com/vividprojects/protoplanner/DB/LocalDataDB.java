...
public class LocalDataDB {
    ...
    public void initDB(){
        ...
        realm.executeTransaction(new Realm.Transaction() {
            @Override
            public void execute(Realm realm) {
                realm.insertOrUpdate(new Currency("AED",784,R.string.AED, context.getResources().getString(R.string.AED_symbol),3,false,0));
                realm.insertOrUpdate(new Currency("AFN",971,R.string.AFN, context.getResources().getString(R.string.AFN_symbol),0,false,0));
                realm.insertOrUpdate(new Currency("ALL",8,R.string.ALL, context.getResources().getString(R.string.ALL_symbol),4,false,0));
                realm.insertOrUpdate(new Currency("AMD",51,R.string.AMD, context.getResources().getString(R.string.AMD_symbol),1,false,0));
                realm.insertOrUpdate(new Currency("ANG",532,R.string.ANG, context.getResources().getString(R.string.ANG_symbol),2,false,0));
                realm.insertOrUpdate(new Currency("AOA",973,R.string.AOA, context.getResources().getString(R.string.AOA_symbol),4,false,0));
                realm.insertOrUpdate(new Currency("ARS",32,R.string.ARS, context.getResources().getString(R.string.ARS_symbol),1,false,0));
                realm.insertOrUpdate(new Currency("AUD",36,R.string.AUD, context.getResources().getString(R.string.AUD_symbol),1,false,0));
                realm.insertOrUpdate(new Currency("AWG",533,R.string.AWG, context.getResources().getString(R.string.AWG_symbol),1,false,0));
                realm.insertOrUpdate(new Currency("AZN",944,R.string.AZN, context.getResources().getString(R.string.AZN_symbol),3,false,0));
                realm.insertOrUpdate(new Currency("BAM",977,R.string.BAM, context.getResources().getString(R.string.BAM_symbol),0,false,0));
                realm.insertOrUpdate(new Currency("BBD",52,R.string.BBD, context.getResources().getString(R.string.BBD_symbol),1,false,0));
                realm.insertOrUpdate(new Currency("BDT",50,R.string.BDT, context.getResources().getString(R.string.BDT_symbol),0,false,0));
                realm.insertOrUpdate(new Currency("BGN",975,R.string.BGN, context.getResources().getString(R.string.BGN_symbol),4,false,0));
                realm.insertOrUpdate(new Currency("BHD",48,R.string.BHD, context.getResources().getString(R.string.BHD_symbol),0,false,0));
                realm.insertOrUpdate(new Currency("BIF",108,R.string.BIF, context.getResources().getString(R.string.BIF_symbol),0,false,0));
                realm.insertOrUpdate(new Currency("BMD",60,R.string.BMD, context.getResources().getString(R.string.BMD_symbol),1,false,0));
                realm.insertOrUpdate(new Currency("BND",96,R.string.BND, context.getResources().getString(R.string.BND_symbol),1,false,0));
                realm.insertOrUpdate(new Currency("BRL",986,R.string.BRL, context.getResources().getString(R.string.BRL_symbol),1,false,0));
                realm.insertOrUpdate(new Currency("BSD",44,R.string.BSD, context.getResources().getString(R.string.BSD_symbol),1,false,0));
                realm.insertOrUpdate(new Currency("BTN",64,R.string.BTN, context.getResources().getString(R.string.BTN_symbol),0,false,0));
                realm.insertOrUpdate(new Currency("BWP",72,R.string.BWP, context.getResources().getString(R.string.BWP_symbol),0,false,0));
                realm.insertOrUpdate(new Currency("BYN",933,R.string.BYN, context.getResources().getString(R.string.BYN_symbol),3,false,0));
                realm.insertOrUpdate(new Currency("BZD",84,R.string.BZD, context.getResources().getString(R.string.BZD_symbol),1,false,0));
                realm.insertOrUpdate(new Currency("CAD",124,R.string.CAD, context.getResources().getString(R.string.CAD_symbol),1,false,0));
                realm.insertOrUpdate(new Currency("CHF",756,R.string.CHF, context.getResources().getString(R.string.CHF_symbol),1,false,1));
                realm.insertOrUpdate(new Currency("CLP",152,R.string.CLP, context.getResources().getString(R.string.CLP_symbol),1,false,0));
                realm.insertOrUpdate(new Currency("CNY",156,R.string.CNY, context.getResources().getString(R.string.CNY_symbol),1,false,1));
                realm.insertOrUpdate(new Currency("COP",170,R.string.COP, context.getResources().getString(R.string.COP_symbol),1,false,0));
                realm.insertOrUpdate(new Currency("CRC",188,R.string.CRC, context.getResources().getString(R.string.CRC_symbol),1,false,0));
                realm.insertOrUpdate(new Currency("CUP",192,R.string.CUP, context.getResources().getString(R.string.CUP_symbol),1,false,0));
                realm.insertOrUpdate(new Currency("CVE",132,R.string.CVE, context.getResources().getString(R.string.CVE_symbol),1,false,0));
                realm.insertOrUpdate(new Currency("CZK",203,R.string.CZK, context.getResources().getString(R.string.CZK_symbol),4,false,0));
                realm.insertOrUpdate(new Currency("DKK",208,R.string.DKK, context.getResources().getString(R.string.DKK_symbol),0,false,0));
                realm.insertOrUpdate(new Currency("DOP",214,R.string.DOP, context.getResources().getString(R.string.DOP_symbol),1,false,0));
                realm.insertOrUpdate(new Currency("DZD",12,R.string.DZD, context.getResources().getString(R.string.DZD_symbol),0,false,0));
                realm.insertOrUpdate(new Currency("EGP",818,R.string.EGP, context.getResources().getString(R.string.EGP_symbol),1,false,0));
                realm.insertOrUpdate(new Currency("ERN",232,R.string.ERN, context.getResources().getString(R.string.ERN_symbol),0,false,0));
                realm.insertOrUpdate(new Currency("ETB",230,R.string.ETB, context.getResources().getString(R.string.ETB_symbol),0,false,0));
                realm.insertOrUpdate(new Currency("EUR",978,R.string.EUR, context.getResources().getString(R.string.EUR_symbol),0,false,10));
                realm.insertOrUpdate(new Currency("FJD",242,R.string.FJD, context.getResources().getString(R.string.FJD_symbol),1,false,0));
                realm.insertOrUpdate(new Currency("FKP",238,R.string.FKP, context.getResources().getString(R.string.FKP_symbol),1,false,0));
                realm.insertOrUpdate(new Currency("GBP",826,R.string.GBP, context.getResources().getString(R.string.GBP_symbol),1,false,1));
                realm.insertOrUpdate(new Currency("GEL",981,R.string.GEL, context.getResources().getString(R.string.GEL_symbol),3,false,0));
                realm.insertOrUpdate(new Currency("GHS",936,R.string.GHS, context.getResources().getString(R.string.GHS_symbol),0,false,0));
                realm.insertOrUpdate(new Currency("GIP",292,R.string.GIP, context.getResources().getString(R.string.GIP_symbol),1,false,0));
                realm.insertOrUpdate(new Currency("GMD",270,R.string.GMD, context.getResources().getString(R.string.GMD_symbol),0,false,0));
                realm.insertOrUpdate(new Currency("GYD",328,R.string.GYD, context.getResources().getString(R.string.GYD_symbol),1,false,0));
                realm.insertOrUpdate(new Currency("HKD",344,R.string.HKD, context.getResources().getString(R.string.HKD_symbol),1,false,0));
                realm.insertOrUpdate(new Currency("HNL",340,R.string.HNL, context.getResources().getString(R.string.HNL_symbol),1,false,0));
                realm.insertOrUpdate(new Currency("HRK",191,R.string.HRK, context.getResources().getString(R.string.HRK_symbol),4,false,0));
                realm.insertOrUpdate(new Currency("HTG",332,R.string.HTG, context.getResources().getString(R.string.HTG_symbol),0,false,0));
                realm.insertOrUpdate(new Currency("HUF",348,R.string.HUF, context.getResources().getString(R.string.HUF_symbol),4,false,0));
                realm.insertOrUpdate(new Currency("IDR",360,R.string.IDR, context.getResources().getString(R.string.IDR_symbol),0,false,0));
                realm.insertOrUpdate(new Currency("ILS",376,R.string.ILS, context.getResources().getString(R.string.ILS_symbol),1,false,1));
                realm.insertOrUpdate(new Currency("INR",356,R.string.INR, context.getResources().getString(R.string.INR_symbol),1,false,0));
                realm.insertOrUpdate(new Currency("IQD",368,R.string.IQD, context.getResources().getString(R.string.IQD_symbol),0,false,0));
                realm.insertOrUpdate(new Currency("IRR",364,R.string.IRR, context.getResources().getString(R.string.IRR_symbol),1,false,0));
                realm.insertOrUpdate(new Currency("ISK",352,R.string.ISK, context.getResources().getString(R.string.ISK_symbol),1,false,0));
                realm.insertOrUpdate(new Currency("JMD",388,R.string.JMD, context.getResources().getString(R.string.JMD_symbol),1,false,0));
                realm.insertOrUpdate(new Currency("JOD",400,R.string.JOD, context.getResources().getString(R.string.JOD_symbol),0,false,0));
                realm.insertOrUpdate(new Currency("JPY",392,R.string.JPY, context.getResources().getString(R.string.JPY_symbol),1,false,1));
                realm.insertOrUpdate(new Currency("KES",404,R.string.KES, context.getResources().getString(R.string.KES_symbol),0,false,0));
                realm.insertOrUpdate(new Currency("KGS",417,R.string.KGS, context.getResources().getString(R.string.KGS_symbol),4,false,0));
                realm.insertOrUpdate(new Currency("KHR",116,R.string.KHR, context.getResources().getString(R.string.KHR_symbol),3,false,0));
                realm.insertOrUpdate(new Currency("KPW",408,R.string.KPW, context.getResources().getString(R.string.KPW_symbol),1,false,0));
                realm.insertOrUpdate(new Currency("KRW",410,R.string.KRW, context.getResources().getString(R.string.KRW_symbol),1,false,0));
                realm.insertOrUpdate(new Currency("KYD",136,R.string.KYD, context.getResources().getString(R.string.KYD_symbol),1,false,0));
                realm.insertOrUpdate(new Currency("KZT",398,R.string.KZT, context.getResources().getString(R.string.KZT_symbol),4,false,0));
                realm.insertOrUpdate(new Currency("LAK",418,R.string.LAK, context.getResources().getString(R.string.LAK_symbol),1,false,0));
                realm.insertOrUpdate(new Currency("LBP",422,R.string.LBP, context.getResources().getString(R.string.LBP_symbol),0,false,0));
                realm.insertOrUpdate(new Currency("LKR",144,R.string.LKR, context.getResources().getString(R.string.LKR_symbol),0,false,0));
                realm.insertOrUpdate(new Currency("LTL",440,R.string.LTL, context.getResources().getString(R.string.LTL_symbol),0,false,0));
                realm.insertOrUpdate(new Currency("LYD",434,R.string.LYD, context.getResources().getString(R.string.LYD_symbol),0,false,0));
                realm.insertOrUpdate(new Currency("MAD",504,R.string.MAD, context.getResources().getString(R.string.MAD_symbol),0,false,0));
                realm.insertOrUpdate(new Currency("MDL",498,R.string.MDL, context.getResources().getString(R.string.MDL_symbol),4,false,0));
                realm.insertOrUpdate(new Currency("MNT",496,R.string.MNT, context.getResources().getString(R.string.MNT_symbol),3,false,0));
                realm.insertOrUpdate(new Currency("MOP",446,R.string.MOP, context.getResources().getString(R.string.MOP_symbol),0,false,0));
                realm.insertOrUpdate(new Currency("MUR",480,R.string.MUR, context.getResources().getString(R.string.MUR_symbol),0,false,0));
                realm.insertOrUpdate(new Currency("MXN",484,R.string.MXN, context.getResources().getString(R.string.MXN_symbol),1,false,0));
                realm.insertOrUpdate(new Currency("NAD",516,R.string.NAD, context.getResources().getString(R.string.NAD_symbol),0,false,0));
                realm.insertOrUpdate(new Currency("NGN",566,R.string.NGN, context.getResources().getString(R.string.NGN_symbol),1,false,0));
                realm.insertOrUpdate(new Currency("NIO",558,R.string.NIO, context.getResources().getString(R.string.NIO_symbol),0,false,0));
                realm.insertOrUpdate(new Currency("NOK",578,R.string.NOK, context.getResources().getString(R.string.NOK_symbol),1,false,0));
                realm.insertOrUpdate(new Currency("NZD",554,R.string.NZD, context.getResources().getString(R.string.NZD_symbol),1,false,0));
                realm.insertOrUpdate(new Currency("OMR",512,R.string.OMR, context.getResources().getString(R.string.OMR_symbol),1,false,0));
                realm.insertOrUpdate(new Currency("PHP",608,R.string.PHP, context.getResources().getString(R.string.PHP_symbol),1,false,0));
                realm.insertOrUpdate(new Currency("PKR",586,R.string.PKR, context.getResources().getString(R.string.PKR_symbol),0,false,0));
                realm.insertOrUpdate(new Currency("PLN",985,R.string.PLN, context.getResources().getString(R.string.PLN_symbol),1,false,0));
                realm.insertOrUpdate(new Currency("PYG",600,R.string.PYG, context.getResources().getString(R.string.PYG_symbol),1,false,0));
                realm.insertOrUpdate(new Currency("QAR",634,R.string.QAR, context.getResources().getString(R.string.QAR_symbol),1,false,0));
                realm.insertOrUpdate(new Currency("RSD",941,R.string.RSD, context.getResources().getString(R.string.RSD_symbol),0,false,0));
                realm.insertOrUpdate(new Currency("RUB",643,R.string.RUB, context.getResources().getString(R.string.RUB_symbol),4,false,10));
                realm.insertOrUpdate(new Currency("SAR",682,R.string.SAR, context.getResources().getString(R.string.SAR_symbol),1,false,0));
                realm.insertOrUpdate(new Currency("SBD",90,R.string.SBD, context.getResources().getString(R.string.SBD_symbol),1,false,0));
                realm.insertOrUpdate(new Currency("SCR",690,R.string.SCR, context.getResources().getString(R.string.SCR_symbol),0,false,0));
                realm.insertOrUpdate(new Currency("SEK",752,R.string.SEK, context.getResources().getString(R.string.SEK_symbol),4,false,0));
                realm.insertOrUpdate(new Currency("SGD",702,R.string.SGD, context.getResources().getString(R.string.SGD_symbol),1,false,1));
                realm.insertOrUpdate(new Currency("THB",764,R.string.THB, context.getResources().getString(R.string.THB_symbol),1,false,0));
                realm.insertOrUpdate(new Currency("TMT",934,R.string.TMT, context.getResources().getString(R.string.TMT_symbol),4,false,0));
                realm.insertOrUpdate(new Currency("TRY",949,R.string.TRY, context.getResources().getString(R.string.TRY_symbol),1,false,0));
                realm.insertOrUpdate(new Currency("TTD",780,R.string.TTD, context.getResources().getString(R.string.TTD_symbol),1,false,0));
                realm.insertOrUpdate(new Currency("TWD",901,R.string.TWD, context.getResources().getString(R.string.TWD_symbol),1,false,0));
                realm.insertOrUpdate(new Currency("TZS",834,R.string.TZS, context.getResources().getString(R.string.TZS_symbol),4,false,0));
                realm.insertOrUpdate(new Currency("UAH",980,R.string.UAH, context.getResources().getString(R.string.UAH_symbol),1,false,0));
                realm.insertOrUpdate(new Currency("USD",840,R.string.USD, context.getResources().getString(R.string.USD_symbol),1,false,10));
                realm.insertOrUpdate(new Currency("UYU",858,R.string.UYU, context.getResources().getString(R.string.UYU_symbol),1,false,0));
                realm.insertOrUpdate(new Currency("VND",704,R.string.VND, context.getResources().getString(R.string.VND_symbol),4,false,0));
            }
        });
        ...
        realm.executeTransaction(new Realm.Transaction() {
            ...
            public void execute(Realm realm) {
                if (measure.hash != 0) {
                    ...
                    Measure_ m = new Measure_(measure, Settings.getMeasureSystem(context));
                    id.item = m.getHash();
