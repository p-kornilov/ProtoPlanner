...
public class SpinnerImageAdapter extends ArrayAdapter<Bundle2<Integer,String>> {
    ...
    public SpinnerImageAdapter(Context context, int resourceId, int resourceDropId, int textViewId, int imageViewId, Bundle2<Integer,String>[] list) {
