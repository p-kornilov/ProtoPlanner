...
public class RecordCategorizedListAdapter extends DataBindingAdapter implements ItemActionsRecord {
    ...
    public RecordCategorizedListAdapter(Context context, String defaultImage) {
    ...
    public void setGrouping(String groupName) {
