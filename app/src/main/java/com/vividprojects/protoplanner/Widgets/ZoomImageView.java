...
/**
 * Created by Smile on 25.01.2018.
 */
...
public class ZoomImageView extends AppCompatImageView implements ScaleGestureDetector.OnScaleGestureListener {
    ...
    public ZoomImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray values = context.obtainStyledAttributes(attrs, R.styleable.ZoomImageView);

        zoomable = values.getBoolean(R.styleable.ZoomImageView_zoomage_zoomable, true);
        translatable = values.getBoolean(R.styleable.ZoomImageView_zoomage_translatable, true);
        animateOnReset = values.getBoolean(R.styleable.ZoomImageView_zoomage_animateOnReset, true);
        autoCenter = values.getBoolean(R.styleable.ZoomImageView_zoomage_autoCenter, true);
        restrictBounds = values.getBoolean(R.styleable.ZoomImageView_zoomage_restrictBounds, false);
        minScale = values.getFloat(R.styleable.ZoomImageView_zoomage_minScale, MIN_SCALE);
        maxScale = values.getFloat(R.styleable.ZoomImageView_zoomage_maxScale, MAX_SCALE);
        autoResetMode = AutoResetMode.Parser.fromInt(values.getInt(R.styleable.ZoomImageView_zoomage_autoResetMode, AutoResetMode.UNDER));
     ...
     *
     * @return the current width of the image as displayed (itself.
     */
     ...
     * it to the outer bounds of the  If the current
